...
\author{
\IEEEauthorblockN{Anderson J. Alvarado\IEEEauthorrefmark{1}, David E. Moreno\IEEEauthorrefmark{2}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}Pontificia Universidad Javeriana, andersonjalvarado@javeriana.edu.co}
\IEEEauthorblockA{\IEEEauthorrefmark{2}Pontificia Universidad Javeriana, morenoa-david@javeriana.edu.co}
}
...
Trabajos en español se han centrado en Twitter \cite{vilares2015} y reseñas de productos \cite{cruz2014}, con menor atención a dominio hotelero. Este estudio aporta dataset de 18,172 reseñas y metodología específica para español peninsular.

\section{Metodología}

\subsection{Dataset y Preprocesamiento}

\textbf{Fuente}: Big Andalusian Hotels Reviews (18,172 reseñas).

\textbf{Distribución de clases}: 14.7\% negativas (0), 12.5\% neutrales (3), 72.8\% positivas (1). La Fig. \ref{fig:class_dist} muestra el desbalance severo que motiva el uso de métricas macro y manejo de pesos de clase.

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{figuras/fig01_distribucion_clases.pdf}}
\caption{Distribución de clases en el dataset (N=18,172). El desbalance severo (72.8\% positivas vs 14.7\% negativas) requiere estrategias específicas de manejo.}
\label{fig:class_dist}
\end{figure}

\textbf{Estadísticas textuales}: Longitud promedio 79 palabras ($\sigma$=95), vocabulario $\sim$45,000 palabras únicas. La Fig. \ref{fig:length_dist} muestra que las reseñas negativas tienden a ser más largas (mediana 165 palabras) que las positivas (mediana 148 palabras), sugiriendo mayor elaboración en críticas.
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{figuras/fig05_eficiencia.pdf}}
